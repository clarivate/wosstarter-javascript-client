...
/**
 * The AuthorName model module.
 * @module model/AuthorName
 * @version 1.0.0
 */
class AuthorName {
    /**
     * Constructs a new <code>AuthorName</code>.
     * @alias module:model/AuthorName
     */
    constructor() { 
        
        AuthorName.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AuthorName</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AuthorName} obj Optional instance to populate.
     * @return {module:model/AuthorName} The populated <code>AuthorName</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuthorName();
 ...
 */
AuthorName.prototype['displayName'] = undefined;

/**
 * Web of Science standard name
 * @member {String} wosStandard
 */
AuthorName.prototype['wosStandard'] = undefined;

/**
 * Web of Science ResearcherID
 * @member {String} researcherId
 */
AuthorName.prototype['researcherId'] = undefined;
