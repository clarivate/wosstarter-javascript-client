...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.AuthorName();
  });
  ...
  describe('AuthorName', function() {
    it('should create an instance of AuthorName', function() {
      // uncomment below and update the code to test AuthorName
      //var instance = new ClarivateWosStarterJsClient.AuthorName();
      //expect(instance).to.be.a(ClarivateWosStarterJsClient.AuthorName);
    });
