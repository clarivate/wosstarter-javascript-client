...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClarivateWosStarterJsClient.OtherName();
  });
  ...
  describe('OtherName', function() {
    it('should create an instance of OtherName', function() {
      ...
      //var instance = new ClarivateWosStarterJsClient.OtherName();
      //expect(instance).to.be.a(ClarivateWosStarterJsClient.OtherName);
    });
