...
(function(root, factory) {
  ...
  describe('JournalsApi', function() {
    ...
    describe('journalsIdGet', function() {
      it('should call journalsIdGet successfully', function(done) {
        //uncomment below and update the code to test journalsIdGet
        //instance.journalsIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
